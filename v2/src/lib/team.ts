...
const executiveBoard: Leader[] = [
  ...
  { name: "Ciaran Nimick",      role: "Finance Lead",                         image: ciaranNimick, graduationYear: "2028", linkedin: "https://www.linkedin.com/in/ciaran-nimick/", framing: { zoom: 1.45, x: 4.32, y: 20.27 } },
  ...
  { name: "Veronica Talan",     role: "Frame & Membership Lead",              image: veronicaTalan, graduationYear: "2028", linkedin: "https://www.linkedin.com/in/veronica-talan-66506733b/", framing: { zoom: 1.36, x: 6.71, y: -15.35 } },
];
...
const operationsBoard: Leader[] = [
  ...
  { name: "Andrew Shen",         role: "Test Engineering Co-Lead",             image: andrewShen, graduationYear: "2029", linkedin: "https://www.linkedin.com/in/andrew-shen-62a4783aa/", framing: { zoom: 1.49, x: 0.31, y: -1.17 } },
  ...
  { name: "Arka Nath",           role: "Brakes Lead",                          image: arkaNath, graduationYear: "2027", linkedin: "https://www.linkedin.com/in/natharka/", framing: { zoom: 1.15, x: -0.54, y: 6.15 } },
...
const specialtyLeads: Leader[] = [
  ...
  { name: "Alissa Fujishiro Yeung", role: "Cost Event Lead",                    image: alissaFujishiroYeung, graduationYear: "2029", linkedin: "https://www.linkedin.com/in/alissa-fujishiro-yeung/", framing: { zoom: 1.7, x: -1.75, y: -21.18 } },
  { name: "David Kaplan",        role: "Documentation Lead",                   image: davidKaplan, graduationYear: "2028", linkedin: "https://www.linkedin.com/in/davidkaplan42/", framing: { zoom: 1.61, x: 1.88, y: 0.36 } },
  { name: "Charles Madland",     role: "Additive Manufacturing Lead",          image: charlesMadland, graduationYear: "2029", linkedin: "https://www.linkedin.com/in/charlesmadland/", framing: { zoom: 1.61, x: 2.45, y: 13.93 } },
  { name: "Sofia Acevedo",       role: "CNC Mini Mill Lead",                   image: sofiaAcevedo, graduationYear: "2029", linkedin: "https://www.linkedin.com/in/sofia-acevedo-39ab15361/", framing: { zoom: 1.75, x: -0.56, y: -9.63 } },
  { name: "Joshua Shropshire",   role: "Mini Baja Lead",                       image: joshuaShropshire, graduationYear: "2029", linkedin: "https://www.linkedin.com/in/joshua-shropshire-3b6b06339/", framing: { zoom: 1.42, x: 1.5, y: -14.53 } },
  { name: "Jessica Shue",        role: "Fundraising Coordinator",              image: jessicaShue, graduationYear: "2027", linkedin: "https://www.linkedin.com/in/jessica-s-7b7935268/", framing: { zoom: 1.37, x: 1.66, y: -10.79 } },
  { name: "Lauren Metzler",      role: "Business Presentation Lead",           image: laurenMetzler, graduationYear: "2029", linkedin: "https://www.linkedin.com/in/lauren-metzler-7651723a2/", framing: { zoom: 1.52, x: 4.55, y: -11.76 } },
  { name: "James Mou",           role: "Engine Lead",                          image: jamesMou, graduationYear: "2029", linkedin: "https://www.linkedin.com/in/james-mou-15932039a/", framing: { zoom: 1.15, x: -5, y: -6.31 } },
];
...
export const GENERAL_BODY: GeneralMember[] = [
  { name: "Abra Giddings",            subteams: ["Systems"],                        classOf: "2028", major: "Electrical Engineering & Computer Science" },
  { name: "Amy Budzichowski",         subteams: ["Suspension"],                     classOf: "2027", major: "Mechanical Engineering" },
  { name: "Ana Newton",               subteams: ["Suspension"],                     classOf: "2027", major: "Mechanical Engineering" },
  { name: "Annelise Reilman",         subteams: ["Test Engineering"],               classOf: "2028", major: "Engineering Physics" },
  { name: "Avaneesh Rao",             subteams: ["Brakes"],                         classOf: "2027", major: "Mechanical & Aerospace Engineering" },
  { name: "Brandon Li",               subteams: ["Systems"],                        classOf: "2029", major: "Computer Engineering" },
  { name: "Charlie Chalfont",         subteams: ["Finance"],                        classOf: "2028", major: "Accounting" },
  { name: "Davis Clarke",             subteams: ["Drivetrain"],                     classOf: "2029", major: "Mechanical Engineering" },
  { name: "Dylan Brick",              subteams: ["Test Engineering"],               classOf: "2027", major: "Mechanical & Aerospace Engineering" },
  { name: "Evelyn Sanchez",           subteams: ["Panels"],                         classOf: "2029", major: "Mechanical & Aerospace Engineering" },
  { name: "Isaac Hugenberger",        subteams: ["Drivetrain"],                     classOf: "2028", major: "Mechanical Engineering" },
  { name: "Jack Fink",                subteams: ["Brakes"],                         classOf: "2028", major: "Mechanical Engineering" },
  { name: "Jake Tan",                 subteams: ["Drivetrain", "Test Engineering"], classOf: "2029", major: "Mechanical Engineering" },
  { name: "Jake Meltzer",             subteams: ["Manufacturing"],                  classOf: "2028", major: "Astronomy" },
  { name: "Jason Wei",                subteams: ["Systems"],                        classOf: "2029", major: "Electrical Engineering" },
  { name: "Jennifer Gonzalez",        subteams: ["Drivetrain"],                     classOf: "2029", major: "Mechanical Engineering" },
  { name: "Lucas Powell",             subteams: ["Test Engineering"],               classOf: "2027", major: "Mechanical Engineering" },
  { name: "Lucy Ma",                  subteams: ["Drivetrain"],                     classOf: "2027", major: "Mechanical Engineering" },
  { name: "Matthew Wang",             subteams: ["Systems"],                        classOf: "2028", major: "Electrical Engineering" },
  { name: "Max Lawton",               subteams: ["Systems"],                        classOf: "2028", major: "Electrical Engineering" },
  { name: "Morgan Ernst",             subteams: ["Frame"],                          classOf: "2028", major: "Materials Science & Engineering" },
  { name: "Nathaniel Leshin",         subteams: ["Drivetrain"],                     classOf: "2029", major: "Mechanical Engineering" },
  ...
  { name: "Phoebe Streiffer",         subteams: ["Systems"],                        classOf: "2029", major: "Electrical Engineering" },
  { name: "Shubham Iyer",             subteams: ["Test Engineering"],               classOf: "2029", major: "Mechanical & Aerospace Engineering" },
  { name: "Syed Hayyan Ali Zaidi",    subteams: ["Test Engineering", "Panels"],     classOf: "2029", major: "Mechanical & Aerospace Engineering" },
  { name: "Uzair Syed",               subteams: ["Systems"],                        classOf: "2026", major: "Electrical Engineering" },
  { name: "Veer Mehta",               subteams: ["Brakes"],                         classOf: "2029", major: "Mechanical & Aerospace Engineering" },
];
