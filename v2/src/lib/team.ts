...
export const GENERAL_BODY: GeneralMember[] = [
  ...
  { name: "Abby Hendrix",             subteams: ["Manufacturing"],                     classOf: "2029", major: "Mechanical Engineering" },
  ...
  { name: "Elad Dov Kleinerman Mordkowitz", subteams: ["CNC"],                        classOf: "2027", major: "Mechanical Engineering" },
  ...
  { name: "Jennifer Gonzalez",        subteams: ["Drivetrain"],                        classOf: "2029", major: "Mechanical Engineering & Materials Science" },
