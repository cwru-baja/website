      ...
      <section className="bg-bg py-24">
        <PageContainer>
          <div className="flex flex-col gap-24">
            ...
            {/* Donate */}
            <div className="border border-white/8 p-12 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
              <div>
                ...
                >
                  MAKE A <span className="text-red">DONATION.</span>
                </h2>
            ...
            {/* Apparel */}
            <div className="border border-white/8 p-12 flex flex-col md:flex-row md:items-center gap-12">
              <div className="shrink-0">
                <Image
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 flex-1">
                <div>
                  <div className="text-[0.65rem] font-medium tracking-[0.25em] uppercase text-white/30 mb-3">
                    Official Merch
                  </div>
                  <h2
                    ...
                    style={{ fontSize: "clamp(2.5rem, 5vw, 5rem)" }}
                  >
                    GET THE <span className="text-red">GEAR.</span>
                  </h2>
                  <p className="mt-4 text-sm text-white/50 max-w-md leading-relaxed">
