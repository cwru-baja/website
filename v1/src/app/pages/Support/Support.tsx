...
import { sponsors, type Sponsor } from "../../../config/sponsors.ts";
    ...
    <FadeIn>
      <div className={styles.donationSection}>
        ...
        <div className={styles.donationInstructions}>
          <strong>Important:</strong> Once reaching the giving form, check
          "other" in the gift designation field and enter "Baja".
        </div>
        <Button
          component="a"
  ...
  return (
    <>
      ...
      <div className={styles.mainContainer}>
        <HeroSection backgroundImage={heroImage} title={"SUPPORT"} />
        ...
        <SponsorTier
          ...
          tierClass="platinum"
        />
        <SponsorTier title="Gold" sponsors={sponsors.gold} tierClass="gold" />
        <SponsorTier
          title="Silver"
